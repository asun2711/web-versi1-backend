...
export class LaboratoriumController {
  constructor(private readonly service: LaboratoriumService) {}
  ...
  async create(@Body() data: any, @UploadedFile() file: any) {
    try {
      if (file) {
        const filePath = join(process.cwd(), 'uploads/laboratorium', file.filename);
      ...
      throw new BadRequestException('Failed to save laboratorium data: ' + error.message);
    }
  }
  ...
  async update(@Param('id') id: string, @Body() data: any, @UploadedFile() file: any) {
    try {
      ...
      throw new BadRequestException('Failed to update laboratorium data: ' + error.message);
    }
  }
  ...
  async remove(@Param('id') id: string) {
    try {
      ...
      throw new BadRequestException('Failed to remove laboratorium data: ' + error.message);
    }
  }
}
