...
export class PengumumanController {
  ...
  @UseInterceptors(
    FileInterceptor('gambarpengumuman', {
      storage: diskStorage({
       destination: './uploads/pengumuman', // Pastikan folder ini ada
  ...
  async create(@Body() data: any, @UploadedFile() file: any) {
    try {
      ...
      throw new BadRequestException('Failed to save pengumuman data: ' + error.message);
    }
  }
  ...
  async update(@Param('id') id: string, @Body() data: any, @UploadedFile() file: any) {
    try {
      ...
      throw new BadRequestException('Failed to update pengumuman data: ' + error.message);
    }
  }
  ...
  async remove(@Param('id') id: string) {
    try {
      ...
      throw new BadRequestException('Failed to remove pengumuman data: ' + error.message);
    }
  }
}
