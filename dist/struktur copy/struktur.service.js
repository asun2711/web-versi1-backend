...
let StrukturService = class StrukturService {
    ...
    async update(id, data) {
        ...
        if (data.gambardireksi && struktur.gambardireksi) {
            const oldFilePath = (0, path_1.join)(__dirname, '..', '..', 'uploads', 'struktur', struktur.gambardireksi);
            try {
    ...
    async remove(id) {
        ...
        if (struktur.gambardireksi) {
            const filepath = (0, path_1.join)(__dirname, '..', '..', 'uploads', 'struktur', struktur.gambardireksi);
            try {
...
exports.StrukturService = StrukturService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(struktur_entity_1.Struktur)),
