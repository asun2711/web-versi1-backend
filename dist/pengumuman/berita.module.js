...
exports.BeritaModule = BeritaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([pengumuman_entity_1.Berita])],
        providers: [pengumuman_service_1.BeritaService],
        controllers: [pengumuman_controller_1.BeritaController],
    })
], BeritaModule);
