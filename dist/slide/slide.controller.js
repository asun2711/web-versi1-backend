...
let SlideController = class SlideController {
    ...
    async create(data, file) {
        try {
            if (file) {
                data.gambarslide = file.filename;
            }
            return await this.service.create(data);
        }
        catch (error) {
            throw new common_1.BadRequestException('Failed to save slide data: ' + error.message);
        }
    }
    async update(id, data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update slide data: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove slide data: ' + error.message);
        }
    }
};
...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('gambarslide', {
...
exports.SlideController = SlideController = __decorate([
    (0, common_1.Controller)('api/dataslide'),
    __metadata("design:paramtypes", [typeof (_a = typeof slide_service_1.SlideService !== "undefined" && slide_service_1.SlideService) === "function" ? _a : Object])
], SlideController);
