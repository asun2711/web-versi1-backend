...
const slide_entity_1 = require("./slide.entity");
...
let BeritaService = class BeritaService {
    ...
    async update(id, data) {
        ...
        if (data.gambarberita && berita.gambarberita) {
            const oldFilePath = (0, path_1.join)(__dirname, '..', '..', 'uploads', 'berita', berita.gambarberita);
            try {
    ...
    async remove(id) {
        ...
        if (berita.gambarberita) {
            const filepath = (0, path_1.join)(__dirname, '..', '..', 'uploads', 'berita', berita.gambarberita);
            try {
...
exports.BeritaService = BeritaService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(slide_entity_1.Berita)),
