...
const radiologi_controller_1 = require("./radiologi.controller");
...
exports.RadiologiModule = RadiologiModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([radiologi_entity_1.Radiologi])],
        providers: [radiologi_service_1.RadiologiService],
        controllers: [radiologi_controller_1.RadiologiController],
    })
], RadiologiModule);
