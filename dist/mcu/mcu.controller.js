...
let McuController = class McuController {
    service;
    constructor(service) {
    ...
    async create(data, file) {
        try {
            if (file) {
                const uploadDir = (0, path_1.join)(process.cwd(), 'uploads/mcu');
                ...
                data.gambarmcu = file.filename;
            }
            return await this.service.create(data);
        }
        catch (error) {
            console.error('CREATE ERROR:', error);
            throw new common_1.BadRequestException('Failed to save mcu data: ' + error.message);
        }
    }
    async update(id, data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update mcu data: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove mcu data: ' + error.message);
        }
    }
};
exports.McuController = McuController;
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], McuController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], McuController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('gambarmcu', {
...
], McuController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('gambarmcu', {
        storage: (0, multer_1.diskStorage)({
    ...
    __metadata("design:returntype", Promise)
], McuController.prototype, "update", null);
__decorate([
