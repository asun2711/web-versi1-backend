...
let StrukturController = class StrukturController {
    ...
    async create(data, file) {
        try {
            if (file) {
                const uploadDir = (0, path_1.join)(process.cwd(), 'uploads/struktur');
            ...
            throw new common_1.BadRequestException('Failed to save struktur data: ' + error.message);
        }
    }
    async update(id, data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update struktur data: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove struktur data: ' + error.message);
        }
    }
};
