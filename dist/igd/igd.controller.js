...
const igd_service_1 = require("./igd.service");
const sharp_1 = __importDefault(require("sharp"));
let IgdController = class IgdController {
    service;
    constructor(service) {
    ...
    async create(data, file) {
        try {
            if (file) {
                const uploadDir = (0, path_1.join)(process.cwd(), 'uploads/igd');
                ...
                data.gambarigd = file.filename;
            }
            return await this.service.create(data);
        }
        catch (error) {
            console.error('CREATE ERROR:', error);
            throw new common_1.BadRequestException('Failed to save igd data: ' + error.message);
        }
    }
    async update(id, data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update igd data: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove igd data: ' + error.message);
        }
    }
};
exports.IgdController = IgdController;
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], IgdController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], IgdController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('gambarigd', {
...
], IgdController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('gambarigd', {
        storage: (0, multer_1.diskStorage)({
    ...
    __metadata("design:returntype", Promise)
], IgdController.prototype, "update", null);
__decorate([
