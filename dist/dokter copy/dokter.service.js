...
let DokterService = class DokterService {
    ...
    async update(id, data) {
        ...
        if (!dokter) {
            throw new common_1.BadRequestException('Dokter not found');
        }
        if (data.gambardokter && dokter.gambardokter) {
            const oldFilePath = (0, path_1.join)(__dirname, '..', '..', 'uploads', 'dokter', dokter.gambardokter);
            try {
    ...
    async remove(id) {
        ...
        if (dokter.gambardokter) {
            const filepath = (0, path_1.join)(__dirname, '..', '..', 'uploads', 'dokter', dokter.gambardokter);
            try {
...
exports.DokterService = DokterService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(dokter_entity_1.Dokter)),
