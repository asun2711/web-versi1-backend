...
let PerusahaanController = class PerusahaanController {
    ...
    async create(data, file) {
        try {
            if (file) {
                const uploadDir = (0, path_1.join)(process.cwd(), 'uploads/perusahaan');
            ...
            throw new common_1.BadRequestException('Failed to save perusahaan data: ' + error.message);
        }
    }
    async update(id, data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update perusahaan data: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove perusahaan data: ' + error.message);
        }
    }
};
...
], PerusahaanController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], PerusahaanController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('logoperusahaan', {
...
], PerusahaanController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('logoperusahaan', {
        storage: (0, multer_1.diskStorage)({
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PerusahaanController.prototype, "remove", null);
exports.PerusahaanController = PerusahaanController = __decorate([
    (0, common_1.Controller)('api/dataperusahaan'),
    __metadata("design:paramtypes", [perusahaan_service_1.PerusahaanService])
