...
let KontenSosialController = class KontenSosialController {
    ...
    async create(data) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to save konten sosial: ' + error.message);
        }
    }
    async update(id, data) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update konten sosial: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove konten sosial: ' + error.message);
        }
    }
};
