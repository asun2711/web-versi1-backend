...
let ContactController = class ContactController {
    ...
    async create(data) {
        try {
            ...
            throw new common_1.BadRequestException('Gagal menyimpan data contact: ' + error.message);
        }
    }
    async findAll() {
    ...
    async findOne(id) {
        ...
        if (!contact) {
            throw new common_1.NotFoundException(`Contact dengan id ${id} tidak ditemukan`);
        }
        return contact;
    }
