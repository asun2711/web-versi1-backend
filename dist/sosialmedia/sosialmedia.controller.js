...
let SosialMediaController = class SosialMediaController {
    ...
    async create(data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to save sosialmedia data: ' + error.message);
        }
    }
    async update(id, data, file) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to update sosialmedia data: ' + error.message);
        }
    }
    async remove(id) {
        try {
            ...
            throw new common_1.BadRequestException('Failed to remove sosialmedia data: ' + error.message);
        }
    }
};
exports.SosialMediaController = SosialMediaController;
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], SosialMediaController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], SosialMediaController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
...
], SosialMediaController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('iconsosialmedia', {
        storage: (0, multer_1.diskStorage)({
    ...
    __metadata("design:returntype", Promise)
], SosialMediaController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SosialMediaController.prototype, "remove", null);
exports.SosialMediaController = SosialMediaController = __decorate([
    (0, common_1.Controller)('api/datasosialmedia'),
    __metadata("design:paramtypes", [sosialmedia_service_1.SosialMediaService])
], SosialMediaController);
//# sourceMappingURL=sosialmedia.controller.js.map